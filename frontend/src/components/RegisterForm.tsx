        ...
        <div className="border rounded-xl p-5 bg-neutral-700">
            <form onSubmit={onSubmit}>
                ...
                <div className="flex flex-row">
                    <div>
                        <input value="Зарегистрироваться" className="text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800" type="submit" />
                    </div>
                    <div>
                        <Link to='/auth/login'>Кo входу</Link>
                    </div>
                </div>
            </form>
        </div>
